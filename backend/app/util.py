...
def log(_func: Callable | None = None, *, my_logger: Union[MyLogger, logging.Logger] = None) -> str:
            ...
            try:
                if my_logger is None:
                    ...
                    logger_params = [  # does kwargs have any logger
                        x for x in kwargs.values() if isinstance(x, (logging.Logger, MyLogger))
                ...
                logger = h_logger.get_logger(func.__name__) if isinstance(h_logger, MyLogger) else h_logger
